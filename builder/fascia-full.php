<section class="divider<?php  echo (get_sub_field('colore_sfondo')=='red') ? ' divider--enphasis' : '' ?> divider--full divider--shrink divider--grow-lg">
    ...
    <a href="<?php the_sub_field('link_pagina') ?>" class="<?php  echo (get_sub_field('colore_sfondo')=='red') ? ' button--reverse' : ' button' ?>"><label><?php the_sub_field('testo_bottone') ?></label></a>
</section>