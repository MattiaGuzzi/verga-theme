<section class="divider<?php  echo (get_sub_field('colore_sfondo')=='red') ? ' divider--red' : '' ?>">
    ...
    <a href="<?php the_sub_field('link_pagina') ?>" class="button--grow-md<?php  echo (get_sub_field('colore_sfondo')=='red') ? ' button' : ' button--reverse' ?>"><?php the_sub_field('testo_bottone') ?></a>
</section>